...
var AuthenticablePrincipal = {
    ...
    InitializeGrid: function ()
    {
        ...
        AuthenticablePrincipal.Grid.jsGrid({
            ...
            fields: [
                { name: "userPrincipalName", type: "text", title: "userPrincipalName" },
                {
                    name: "alternativeUserPrincipalNames",
                    title: "alternativeUserPrincipalNames",
                ...
                { name: "localLogonEnabled", type: "checkbox", title: "localLogonEnabled" },
                { name: "enabled", type: "checkbox", title: "Enabled", sorting: false },
                {
                    ...
                    itemTemplate: function (value, item) {
                        ...
                        //var $myButton = $("<button>");
                        //var btn = $("<i>").on('click', AuthenticablePrincipal.ResetPasswordButtonClick);
                        //var btn = $("<i>");
                        //btn.attr("onclick", "AuthenticablePrincipal.ResetPasswordButtonClick('" + item.id + "','" + item.userPrincipalName + "');");
                        ...
                        return btn.on("click", function (event) {
                                //var c = AuthenticablePrincipal.Grid.jsGrid("rowByItem", a);
